...
@_silgen_name("OAGTypeApplyFields")
private func OAGTypeApplyFields(
    of type: Any.Type,
    body: (UnsafePointer<Int8>, Int, Any.Type) -> Void
)

@_silgen_name("OAGTypeApplyFields2")
private func OAGTypeApplyFields2(
    of type: Any.Type,
...
public func forEachField(
    ...
    OAGTypeApplyFields(of: type, body: body)
}
...
extension Metadata: Swift.Hashable, Swift.CustomStringConvertible {
    ...
    public var description: String {
        #if canImport(ObjectiveC)
        __OAGTypeDescription(self) as NSString as String
        #else
    ...
    public func forEachField(
        ...
        OAGTypeApplyFields2(of: type, options: options, body: body)
    }
}
