...
public struct Attribute<Value> {
    ...
    public init<Body: _AttributeBody>(
        ...
        fatalError("Swift 5.9.1 Compiler issue - type mismatch of Unmanaged<OAGGraphContext> and OAGGraphContext")
        #else
...
@inline(__always)
@inlinable
func OAGGraphSetValue<Value>(_ attribute: AnyAttribute, valuePointer: UnsafePointer<Value>) -> Bool
