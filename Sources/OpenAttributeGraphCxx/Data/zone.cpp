...
ptr<void> zone::alloc_slow(uint32_t size, uint32_t alignment_mask) OAG_NOEXCEPT {
    if (last_page()) {
...
void zone::print() const OAG_NOEXCEPT {
...
void zone::print_header() const OAG_NOEXCEPT {
